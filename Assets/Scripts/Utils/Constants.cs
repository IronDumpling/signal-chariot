namespace Utils
{
    public static class Constants 
    {
        ...
        public const string UI_WAVE_WIN_PATH = "UIs/Battle/WaveWin";
        public const string UI_BATTLE_WIN_PATH = "UIs/Battle/BattleWin";
        public const string UI_FAIL_PATH = "UIs/Battle/BattleFail";
        public const string UI_ANDROID_STATUS_PATH = "UIs/Common/AndroidStatus";
        ...
        public const string VFX_EXPLOSION_PATH = "Prefabs/VFXs/Explosion";
        public const string VFX_HIT_PATH = "Prefabs/VFXs/Hits/Hit_02";
